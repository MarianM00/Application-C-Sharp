...
{   
    public partial class AdminUserEdit : Form
    {
        ...
        private void currentPosition()
        {
            ...
            rowNumber = usersBindingSource.Count;
            CurrentPosition = usersBindingSource.Position + 1;
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT " + table + " WHERE NameUser = " + TxtNameUser.Text);
        ...
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            this.usersTableAdapter.Update(this.taskDataSet);
