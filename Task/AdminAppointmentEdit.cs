...
namespace Task
{   
    public partial class AdminAppointmentEdit : Form
    {
        ...
        private void currentPosition()
        {
            ...
            rowNumber = appointmentsBindingSource.Count;
            CurrentPosition = appointmentsBindingSource.Position + 1;
        ...
        {
            this.appointmentsBindingSource.MoveNext();
            currentPosition();
        ...
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            this.appointmentsTableAdapter.Update(this.taskDataSet1);
            MessageBox.Show("The appointments table is updated.");
        }

        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            this.appointmentsBindingSource.MovePrevious();
            currentPosition();
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            this.appointmentsBindingSource.MoveFirst();
            currentPosition();
        }

        private void bunifuButton5_Click(object sender, EventArgs e)
        {
            this.appointmentsBindingSource.MoveLast();
            currentPosition();
        }
