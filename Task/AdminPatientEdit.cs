...
namespace Task
{   
    public partial class AdminPatientEdit : Form
    {
        ...
        private void currentPosition()
        {
            ...
            rowNumber = patientsBindingSource.Count;
            CurrentPosition = patientsBindingSource.Position + 1;
        ...
        {
            this.patientsBindingSource.MoveNext();
            currentPosition();
        ...
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            this.patientsTableAdapter.Update(this.taskDataSet1);
            MessageBox.Show("The doctors table is updated.");
        }

        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            this.patientsBindingSource.MovePrevious();
            currentPosition();
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            this.patientsBindingSource.MoveFirst();
            currentPosition();
        }

        private void bunifuButton5_Click(object sender, EventArgs e)
        {
            this.patientsBindingSource.MoveLast();
            currentPosition();
        }
