...
{   
    public partial class AdminUser : Form
    {
            ...
            private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            usersTableAdapter.Update(taskDataSet.Users);
            MessageBox.Show("The table has updated!");
        }

        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            AdminUserEdit newform = new AdminUserEdit();
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            query = string.Format("delete from users where UsersId like {0}", deleteValue);
        ...
        public void searchData(string searchValue)
        {
            ...
            string query = "select * from users where NameUser like '%" + searchValue + "%'";
            ...
            usersBindingSource.DataSource = dataTbl;
        }
        ...
        {
            AdminUserAdd newform = new AdminUserAdd();
            newform.ShowDialog(this);
        }
    }
    }
