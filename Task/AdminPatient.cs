...
{   
    public partial class AdminPatient : Form
    {
            ...
            private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            patientsTableAdapter.Update(taskDataSet1.Patients);
            MessageBox.Show("The table has updated!");
        }

        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            AdminPatientEdit newform = new AdminPatientEdit();
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            query = string.Format("delete from Patients where CodePatient like {0}", deleteValue);
        ...
        public void searchData(string searchValue)
        {
            ...
            string query = "select * from Patients where NamePatient like '%" + searchValue + "%'";
            ...
            patientsBindingSource.DataSource = dataTbl;
        }
        ...
        {
            AdminPatientAdd newform = new AdminPatientAdd();
            newform.ShowDialog(this);
        }
