...
{   
    public partial class AdminDoctor : Form
    {
            ...
            private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            doctorsTableAdapter.Update(taskDataSet1.Doctors);
            MessageBox.Show("The table has updated!");
        }

        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            AdminDoctorEdit newform = new AdminDoctorEdit();
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            query = string.Format("delete from Doctors where CodeDoctor like {0}", deleteValue);
            CreateCommand(query, connectionString);
            MessageBox.Show("Doctors has been removed!");
            Hide();
        }
        public void searchData(string searchValue)
        {

            string query = "select * from Doctors where NameDoctor like '%" + searchValue + "%'";
            ...
            doctorsBindingSource.DataSource = dataTbl;
        }
        ...
        {
            AdminDoctorAdd newform = new AdminDoctorAdd();
            newform.ShowDialog(this);
        }
